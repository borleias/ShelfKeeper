...
namespace ShelfKeeper.Infrastructure.Persistence
{
    ...
    public class ApplicationDbContext : DbContext, IApplicationDbContext
    {
        ...
        /// <returns>A <see cref="Task{TResult}"/> representing the asynchronous save operation. The task result contains the number of state entries written to the database.</returns>
